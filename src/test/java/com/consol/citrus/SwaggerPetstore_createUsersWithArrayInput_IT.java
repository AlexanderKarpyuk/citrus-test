 ...
 * @since 2021-03-19
 */
public class SwaggerPetstore_createUsersWithArrayInput_IT extends TestNGCitrusSupport {
    @CitrusTest
    @Test
    @Parameters("runner")
    public void swaggerPetstore_createUsersWithArrayInput_IT(
            @CitrusResource @Optional TestCaseRunner runner) {
        runner.run(echo("TODO: Code the test SwaggerPetstore_createUsersWithArrayInput_IT"));
